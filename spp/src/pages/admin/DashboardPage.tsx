...
import { Card, Badge, Button, Table, formatRupiah, formatDateIndo } from '../../components/ui';
import { 
  TrendingUp, 
  Users, 
  CreditCard, 
...
export const DashboardPage: React.FC = () => {
  ...
  const recentPayments = [
    { id: 'INV-2026-0701', student: "Muhammad Faiz Syafi'i", grade: 'XI-IPA-1', item: 'SPP Juli 2026', amount: 1500000, method: 'QRIS', status: 'PAID' as const, date: '2026-07-26T08:30:00Z' },
    { id: 'INV-2026-0702', student: "Aisyah Zahra Syafi'i", grade: 'X-A', item: 'SPP Juli + Uang Kegiatan', amount: 2000000, method: 'VA_BCA', status: 'PAID' as const, date: '2026-07-26T08:15:00Z' },
    { id: 'INV-2026-0703', student: 'Rifky Hidayatullah', grade: 'XII-IPS-2', item: 'Cicilan 1 SPP Juli', amount: 750000, method: 'MANUAL_TRANSFER', status: 'PARTIAL' as const, date: '2026-07-25T19:40:00Z' },
    { id: 'INV-2026-0704', student: 'Zayyan Al-Ghazali', grade: 'X-B', item: 'SPP Juni & Juli 2026', amount: 3000000, method: 'VA_MANDIRI', status: 'PAID' as const, date: '2026-07-25T14:20:00Z' },
    { id: 'INV-2026-0705', student: 'Nayla Quratul Ain', grade: 'XI-IPA-2', item: 'Infaq Renovasi Masjid', amount: 500000, method: 'EWALLET_GOPAY', status: 'PAID' as const, date: '2026-07-25T11:10:00Z' },
  ];
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {stats.map((st, idx) => {
          const Icon = st.icon;
          return (
            <Card key={idx} variant="glass" padding="md" className="flex flex-col justify-between hover:shadow-glass-hover">
              ...
              {st.percent && (
                <div className="mt-4">
                  ...
                  <div className="w-full h-2 rounded-full bg-slate/15 overflow-hidden">
                    <div
                      className={`h-full rounded-full transition-all duration-1000 ${st.color === 'emerald' ? 'bg-emerald-primary' : 'bg-gold-accent'}`}
      ...
      {/* Grid: Recent Transactions & Quick Navigation */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        {/* Recent Transactions Table (2 Cols) */}
        <div className="lg:col-span-2 flex flex-col gap-4">
          <div className="flex items-center justify-between gap-2">
            <h3 className="text-base sm:text-lg md:text-xl font-extrabold text-obsidian flex items-center gap-2 font-heading truncate">
              <Clock className="w-5 h-5 text-emerald-primary shrink-0" />
              <span className="truncate">Transaksi Pembayaran Terkini</span>
            </h3>
            <button
              type="button"
              onClick={() => navigate('/admin/reports')}
              className="text-xs font-bold text-emerald-primary hover:underline flex items-center gap-1 shrink-0"
            >
          ...
          <Table
            ...
            columns={[
              ...
              },
              {
                ...
                cell: (item) => (
                  <div>
                    <span className="text-xs font-bold uppercase block">{item.method.replace('_', ' ')}</span>
        ...
        <div className="lg:col-span-1 flex flex-col gap-6">
          <Card variant="glass" padding="lg" className="border-2 border-emerald-primary/20">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-extrabold text-obsidian text-base flex items-center gap-2 font-heading">
            ...
            <div className="flex flex-col gap-2.5">
              <Button
                ...
                size="sm"
                fullWidth
                leftIcon={<CreditCard className="w-4 h-4 text-emerald-primary" />}
                className="justify-start font-bold"
                onClick={() => navigate('/admin/spp')}
              >
              ...
              <Button
                ...
                size="sm"
                fullWidth
                leftIcon={<FileText className="w-4 h-4 text-emerald-primary" />}
                className="justify-start font-bold"
                onClick={() => navigate('/admin/non-spp')}
              >
              ...
              <Button
                ...
                size="sm"
                fullWidth
                leftIcon={<Settings className="w-4 h-4 text-emerald-primary" />}
                className="justify-start font-bold"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Button
                  ...
                  onClick={() => success('Pengingat Terkirim', 'Pesan pengingat WhatsApp telah diproses ke 68 wali santri.')}
                >
